...
INSERT IGNORE INTO `tbl_users` (username, password, role, name, is_active)
VALUES ('admin', 'admin', 'Admin', 'System Administrator', 1);

-- Insert default VAT record if not exists
INSERT IGNORE INTO `tbl_vat` (vat) VALUES (0.00);
