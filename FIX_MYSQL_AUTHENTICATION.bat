...
mysql -h 127.0.0.1 -P 3310 -u root -pShivaanica -e "SELECT 'Password OK!' AS Status;" 2>&1
if %errorlevel% equ 0 (
    echo.
...
echo ----------------------------------------
echo 1. Run: mysql -h 127.0.0.1 -P 3310 -u root -p
...
echo 5. Start MySQL
echo 6. Run: mysql -h 127.0.0.1 -P 3310 -u root
